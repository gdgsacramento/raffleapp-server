...
/*
 * This var has to be outside the angular-old factory, otherwise when
...
function mdCompilerService($q, $http, $injector, $compile, $controller, $templateCache) {
   ...
   * @module material.core
   * @description
   * The $mdCompiler service is an abstraction of angular-old's compiler, that allows the developer
      ...
      return {
        ...
        link: function link(scope) {
          ...
          if (controller) {
            ...
            var ctrl = invokeCtrl();
            //See angular-old-route source for this logic
 ...
 * </hljs>
 * <hljs lang="js">
 * var app = angular-old.module('app', ['ngMaterial']);
 ...
 *   e.g. angular-old.element(document.getElementById('content')) or "#content"
 ...
 *
 * @description
 * The checkbox directive is used like the normal [angular-old checkbox](https://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D).
 *
 * As per the [material design spec](http://www.google.com/design/spec/style/color.html#color-ui-color-application)
 * the checkbox is in the accent color by default. The primary color palette may be used with
 * the `md-primary` class.
 *
 * @param {string} ng-model Assignable angular-old expression to data-bind to.
 ...
 * <hljs lang="js">
 * (function(angular-old, undefined){
 *   "use strict";
 *
 *   angular-old
 ...
 *        var parentEl = angular-old.element(document.body);
 *        $mdDialog.show({
 *          parent: parentEl,
 *          targetEvent: $event,
 *          template:
 ...
 *
 * <hljs lang="js">
 *  angular-old.module('appSvgIconSets', ['ngMaterial'])
 ...
 *  angular-old.config(function($mdIconProvider) {
...
"use strict";
  ...
  /**
    ...
    *
    *     angular-old.forEach(urls, function(url) {
 ...
 *
 * <hljs lang="js">
 * var app = angular-old.module('myApp', ['ngMaterial']);
 ...
 * @restrict E
 *
 * The switch directive is used very much like the normal [angular-old checkbox](https://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D).
 *
 * As per the [material design spec](http://www.google.com/design/spec/style/color.html#color-ui-color-application)
...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $mdTheming, $window,
  ...
  /**
   * Gathers angular-old-wrapped versions of each element
   * @param elements
   * @returns {{}}
   */
 ...
 *   <img ng-src="img/angular-old.png" class="centered">
 *   <md-tab
